...
const Player = (props) => {
    ...
    return (
        <div className="bg-gray-100 rounded-xl items-center p-3 m-4">
            ...
            <button onClick={()=> props.handleAddToCart(props.player)} class="bg-blue-500 hover:bg-blue-700 text-white font-bold m-2 py-2 px-6 border border-blue-700 rounded-lg">
                Add to Cart
            </button>
        </div>
    );
