...
const CartPlayers = (props) => {
    ...
    return (
        <div className="flex  border-b border-blue-500 p-2">
            ...
            <button onClick={() => props.handleRemoveFromCart(props.player)} className="bg-red-500 hover:bg-red-700 text-white font-bold px-4 border border-red-700 rounded-lg">
                Remove
            </button>
        </div>
    );
